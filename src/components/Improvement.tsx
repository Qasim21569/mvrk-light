...
const phases = [
  {
    ...
    icon: <Wrench className="w-12 h-12 text-mvrk-teal" />
  },
  {
    letter: "E",
    title: "Enhance",
    ...
    icon: <Zap className="w-12 h-12 text-mvrk-teal" />
  },
  {
    letter: "T",
    title: "Transform",
    ...
    icon: <Sparkles className="w-12 h-12 text-mvrk-teal" />
  }
];
      ...
      <div className="container mx-auto px-6 z-10">
        ...
        >
          <p className="flex items-center justify-center space-x-2">
            ...
            <ArrowIcon />
            <span className="text-mvrk-teal font-semibold">E</span>
            <ArrowIcon />
            <span className="text-mvrk-teal font-semibold">T</span>
          </p>
        </motion.div>
      </div>
    </section>
